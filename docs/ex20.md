...
<video controls src="/home/elenhelen/ASC-ODE-team09/docs/data_ex3/ms_nodis_largek.mp4" width="600">
</video>
...
<video controls src="/home/elenhelen/ASC-ODE-team09/docs/data_ex3/ms_nodis_smallk.mp4" width="600">
</video>
...
### 3D Version: Mass-Spring system with Lagrangian Constraint

Add constrains directly in `.ipnb` to see the 3D version
...
2. Using `DistanceConstraint` and assume the fixed distance 1:
