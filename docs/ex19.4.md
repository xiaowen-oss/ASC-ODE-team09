...
② For each method and each τ, we solve the mass–spring system on $[0,8\pi]$ and write CSV files  `ex19_4_rk2.csv` `ex19_4_rk4.csv` `ex19_4_irk_gauss2.csv``ex19_4_radau2a.csv`
